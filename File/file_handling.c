...
#define N 2  // Define the number of records
...
int main() {
    ...
    fwrite(records, sizeof(struct Record), N, file);
    fclose(file);
    ...
    fread(records, sizeof(struct Record), N, file);
    fclose(file);
